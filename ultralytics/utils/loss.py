...
from ultralytics.utils.tal import RotatedTaskAlignedAssigner, SizeAdaptiveAssigner, TaskAlignedAssigner, dist2bbox, dist2rbox, make_anchors
...
class v8DetectionLoss:
    ...
    def __init__(self, model, tal_topk: int = 10, tal_topk2: int | None = None, size_adaptive: bool = False):  # model must be de-paralleled
        ...
        assigner_cls = SizeAdaptiveAssigner if size_adaptive else TaskAlignedAssigner
        self.assigner = assigner_cls(
            topk=tal_topk,
            num_classes=self.nc,
            alpha=0.5,
            beta=6.0,
